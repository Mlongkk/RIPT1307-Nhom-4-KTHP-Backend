-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'DOCTOR', 'CUSTOMER');

-- CreateEnum
CREATE TYPE "PriorityLevel" AS ENUM ('EMERGENCY', 'URGENT', 'NORMAL');
...
CREATE TABLE "Appointment" (
    ...
    "priority_level" "PriorityLevel" NOT NULL DEFAULT 'NORMAL',
...
-- AddForeignKey
ALTER TABLE "Invoice" ADD CONSTRAINT "Invoice_petId_fkey" FOREIGN KEY ("petId") REFERENCES "Pet"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
